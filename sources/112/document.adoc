...
A label style is a collection of labellers, sequences, templates, and contexts
that define a coherent labeling system for a document.

Steps to creating a label style:
